...
class CollectionTest {
    ...
    @Test
    fun isNullOrEmptyWithNullPasses() {
        assert(null as List<Any?>?).isNullOrEmpty()
    }

    @Test
    fun isNullOrEmptyPasses() {
        assert(emptyList<Any?>()).isNullOrEmpty()
    }

    @Test
    fun isNullOrEmptyFails() {
        val error = assertFails {
    ...
    //region containsNone
    @Test
    fun containsNonePasses() {
        assert(emptyList<Any?>()).containsNone(1)
    }

    @Test
    fun containsNoneFails() {
        val error = assertFails {
    ...
    //region containsAll
    @Test
    fun containsAllPasses() {
        assert(listOf(1, 2)).containsAll(2, 1)
    }

    @Test
    fun containsAllFails() {
        val error = assertFails {
    ...
    //region containsOnly
    @Test
    fun containsOnlyPasses() {
        assert(listOf(1, 2)).containsOnly(2, 1)
    }

    @Test
    fun containsOnlyElementsMissingFails() {
        val error = assertFails {
    ...
    @Test
    fun containsOnlyUnexpectedElementsFails() {
        val error = assertFails {
